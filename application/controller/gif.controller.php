<?php
	...
	class Gif extends Controller
	{
		...
		public function index($page = 1, $error = array(true, ""))
		{
			...
			$this->title = "Gif";
			$this->renderLayoutView('board', ['error' => $error, 'page' => $page, 'threads' => $threadModel->getAllThreadsBoard(2, $page)]);
		}
		...
		public function create()
		{
			if(isset($_POST['btnPost']))
			{
				...
				if($img_name[0])
				{
					$threadModel->createThread($thread_info["username"], $thread_info["staff"], $thread_info["subject"], $thread_info["comment"], $img_name[1], 2);
